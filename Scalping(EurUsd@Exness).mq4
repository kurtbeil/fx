...
double long_tp_size = 2.8;
double long_sl_size = 40;
double short_tp_size = 2.8;
double short_sl_size = 40;
...
int init() {
	...
	long_tp_size = StandardPointSize() *  long_tp_size;
	long_sl_size =  StandardPointSize() *  long_sl_size;
	short_tp_size = StandardPointSize() * short_tp_size;
	short_sl_size = StandardPointSize() * short_sl_size;
}
